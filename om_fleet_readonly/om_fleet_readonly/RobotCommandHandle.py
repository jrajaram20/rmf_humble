...
class RobotCommandHandle(adpt.RobotCommandHandle):
    ...
    def stop(self):
        self.node.get_logger().info(f"navigration control not available - stop command from rmf")
    ...
    def follow_new_path(
        ...
        self.node.get_logger().info(f"navigration control not available - new path available in rmf")
    ...
    def dock(
        ...
        self.node.get_logger().info(f"navigration control not available - dock command from rmf")
