...
from om_aiv_navigation.socket_taskmaster import *
from om_aiv_navigation.parser import *
...
class LDActionServer(Node):
    def __init__(self):
        ...
        self.passwd = self.declare_parameter("arcl_passwd").value
        #self.passwd = str("omron")
        #self.ip_address = "192.168.48.70"
        #self.port = "7171"
    ...
    def execute_callback(self, goal):
        self.get_logger().info(f"hiiii,[{goal.request.command}]")
